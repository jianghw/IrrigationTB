...
public class AppUtils {
    ...
    private static  LruCache<String, String> mBeanCache;
    ...
    public static int getVerCode() {
        int verCode = -1;
        try {
            String packageName = TbApp.instance().getPackageName();
            verCode = TbApp.instance().getPackageManager().getPackageInfo(packageName, 0).versionCode;
    ...
    public static int gc(Context context) {
        ...
        if (DEBUG) {
            KLog.d(TAG, "清理了" + (getDeviceUsableMemory(context) - i) + "M内存");
        }
        return count;
    }
    ...
    public static LruCache<String,String> getLruCache(){
        if(null==mBeanCache){
            ...
            mBeanCache = new LruCache<>(maxMemory/8);
        }
        return mBeanCache;
    }
