...
public class VisitAdapter extends BaseAdapter {
    ...
    public VisitAdapter(Context context, ArrayList<VisitBean> list) {
        mContext = context;
        mList = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (bean.getActually_time() != null && bean.getSetting_date().equals(time)) {
            holder.mTvType.setBackgroundResource(R.color.activity_controls_normal_green);
        } else if (bean.getActually_time() != null && !bean.getSetting_date().equals(time)) {
